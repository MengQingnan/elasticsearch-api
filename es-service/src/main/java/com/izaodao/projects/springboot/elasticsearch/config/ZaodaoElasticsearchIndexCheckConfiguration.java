...
//
//    public ZaodaoElasticsearchIndexCheckConfiguration(ElasticsearchTemplate elasticsearchTemplate) {
...
//        } else if (!elasticsearchTemplate.indexExists(esOperParamters.getIndex())) {
//            // 默认索引配置
//            Map<String, Object> setting = new HashMap<>();
//
//            setting.put("refresh_interval", "1s");
//            setting.put("number_of_shards", "5");
//            setting.put("number_of_replicas", "1");
//            setting.put("store", new HashMap<String, Object>(){
//                {
//                    put("type","fs");
//                }
//            });
//            elasticsearchTemplate.createIndex(esOperParamters.getIndex(), setting);
//        }
//
